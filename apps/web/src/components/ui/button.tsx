    ...
    'inline-flex rounded-md items-center justify-center text-sm font-medium disabled:opacity-50 disabled:pointer-events-none ',
    {
        variants: {
            variant: {
                ...
                //duration-300 hover:-translate-y-0.5 hover:border-beige-700
                outline:
                    'flex cursor-pointer items-center justify-center rounded-3xl border border-gray-200 shadow-sm transition hover:bg-beige-100',
