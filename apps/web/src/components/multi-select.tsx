...
>(
  (
    ...
    const [selected, setSelected] = React.useState<Option[]>(list.value || []);
    ...
    return (
      ...
      >
        ...
        <div className='relative'>
          {open && (
            <CommandList className='absolute top-0 z-10 mt-2 w-full rounded-md border border-gray-100 bg-white shadow-md outline-none animate-in'>
              {isLoading ? (
                <>{loadingIndicator}</>
              ) : (
                <>
