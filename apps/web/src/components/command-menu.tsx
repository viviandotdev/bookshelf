...
//           {...props}
//         />
//         <kbd className='pointer-events-none absolute right-1.5 top-1.5 hidden h-5 select-none items-center gap-1 rounded border bg-background px-1.5 font-mono text-[10px] font-medium text-gray-500 opacity-100 sm:flex'>
...
//                   <CommandItem
//                     key={book.id}
//                     value={`${book.title} ${book.authors[0]}`}
//                     onSelect={() => {
