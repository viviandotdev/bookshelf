...
export const AcitvityTemplate: React.FC<AcitvityTemplateProps> = ({
  ...
  return (
    <div>
      <div className='mx-auto my-12 flex w-[950px] flex-col justify-center'>
        <h3
      ...
      <div className='flex justify-center'>
        <div className='sticky top-5 h-[300px] w-[200px]'>
          <div className=''>
            <BookCover
              src={book.coverImage}
              className='w-[fill-available] max-w-none justify-start rounded-lg'
              size={'lg'}
            />
