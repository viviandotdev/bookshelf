...
const FooterSection: React.FC<FooterSectionProps> = () => {
  ...
  return (
    <>
      <div className='flex flex-col items-center justify-center bg-neutral-100 p-4 py-[8rem]'>
        <div className='flex w-full flex-col items-center'>
          ...
          <button className='rounded-lg  bg-beige-700 px-12 py-4 text-base font-medium text-white shadow'>
