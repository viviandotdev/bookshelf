'use client';
import { Size, useJournalEntriesLazyQuery } from '@/graphql/graphql';
    ...
    return {
      ...
      entry: {
        ...
        image:
          entry.userBook &&
          entry.userBook.book &&
          getCoverUrl(entry.userBook.book, Size.Small),
      },
      progress: {
      ...
      <section className='relative z-0 space-y-6 pb-8 pt-12'>
        <div className='bg-white'>
          <Heading
            ...
            title={title}
            subTitle={bookId ? 'Your Journal Entries for' : ''}
          />
          <div className='grid grid-cols-1 gap-4 nav-lg:grid-cols-3'>
            <StatCard
