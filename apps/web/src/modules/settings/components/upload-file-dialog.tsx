            ...
            <DialogContent className="sm:max-w-[425px]">
                <form onSubmit={handleSubmit(handleFileUpload)}>
                    ...
                    <div className="grid gap-4 py-4">
                        <div className="border-dashed border-2 rounded-lg flex flex-col items-center justify-center p-6 space-y-2">
                            <UploadIcon className="h-8 w-8 text-gray-500 dark:text-gray-400" />
                            <p className="text-sm text-gray-500 dark:text-gray-400">Drag and drop your file here</p>
                        </div>
                        <div className="grid w-full max-w-sm items-center gap-1.5">
                            <Label htmlFor="file">Or select a file from your device</Label>
                            <Input className="cursor-pointer" id="file" type="file" accept=".csv" {...register('file')} />
                        </div>
                    </div>
                    <DialogFooter>
