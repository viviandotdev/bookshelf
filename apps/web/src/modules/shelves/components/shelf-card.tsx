    ...
    <Card className='w-full'>
      <CardHeader>
        <div className='mb-2 flex items-center'>
          <Avatar size={'md'}>
            <AvatarImage alt='Vivian' />
            <AvatarFallback>JJ</AvatarFallback>
          </Avatar>
          <div className='ml-3'>
            <p className='mb-0.5 text-sm font-medium text-gray-900'>
              <span className='mr-1 text-gray-500'>List</span>
              created by @Vivian
            </p>
            <div className='flex space-x-1 text-sm font-medium text-beige-700 '>
              <span className='ml-[-3px] rounded-lg bg-beige-100  p-0.5 px-1.5 text-xs '>
                100 books
              </span>
              <span aria-hidden='true'>·</span>
              <span className='flex gap-2 rounded-lg bg-beige-100 p-0.5 px-1.5 text-xs'>
                12/123 Read
              </span>
            </div>
          </div>
