...
export default async function MyBooksPage({ params }: MyBooksPageProps) {
  ...
  return (
    <div className="grid w-full items-center mt-5">
        ...
        <ContentNav nav={myBooksConfig.contentNav} sorting={myBooksConfig.sortingSelects} />
        <hr className="mt-1 border-t-1 border-primary" />
        <div className="mt-5"><div className="flex justify-between overflow-hidden flex-col md:flex-row m-0">
          <BookProgressCard />
          <BookProgressCard />
          <BookProgressCard />
        </div>
