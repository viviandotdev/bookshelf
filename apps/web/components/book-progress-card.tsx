...
export function BookProgressCard({ className, ...props }: CardProps) {
  return (
    <Card className={cn("sm-max:w-[60vw] md:w-[280px] lg:w-[320px] border-none shadow-none p-0 overflow-hidden", className)} {...props}>
      <CardContent className="p-4 flex gap-4">
        ...
        <div className="flex items-start flex-col justify-center gap-1 xl:gap-2">
          <CardTitle className="text-[16px] leading-tight ">When Breath Becomessfjslakfjlksjflksdjflasdjf;lksadjfl</CardTitle>
          <CardDescription className="text-sm line-clamp-1">by Paul Kalanit</CardDescription>
      ...
      <CardFooter className={cn("sm-max:w-[60vw] md:w-[280px] lg:w-[320px]", "justify-bewteen space-x-2")} {...props}>
          <Progress value={33} />
